//! CONTRACT: docs/contracts/hot-path-attribution.md#HPA-12.
//!
...
/// HPA-12: direct construction and deserialization enforce the same identity.
#[test]
...
/// HPA-12: a hexadecimal digest cannot contain a numeric sign.
#[test]
fn signed_pairs_are_not_hexadecimal_digests() {
    assert!("+1".repeat(32).parse::<Sha256Hex>().is_err());
}

/// HPA-12: aggregation cannot launder invalid identities or mix interval kinds.
#[test]
