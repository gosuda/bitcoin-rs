...
pub(crate) fn empty_result() -> OwnershipScanResult {
    OwnershipScanResult {
...
pub(crate) fn cfg_test_module_stems_from<I>(contents: I) -> BTreeSet<String>
where
...
pub(crate) fn is_test_module_file(path: &Path, test_modules: &BTreeSet<String>) -> bool {
    path.file_stem()
...
pub(crate) fn code_line(raw: &str, state: &mut LexState) -> String {
...
pub(crate) fn scan_source(path_str: &str, content: &str, result: &mut OwnershipScanResult) {
...
pub(crate) fn is_authorized_gateway_call(
    path: &str,
    line: &str,
    method_pos: usize,
    lines: &[String],
