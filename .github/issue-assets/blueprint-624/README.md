...
| File | View |
| --- | --- |
| 01-ownership.svg | Selected dependency and construction edges |
| 02-durable-commit.svg | Durable commit and publication order |
| 03-admission.svg | Shared transaction admission and preview |
| 04-recovery.svg | Restart and crash recovery |
| 05-waterfall.svg | Acceptance stages |
| 06-index-capabilities.svg | Optional-index state transitions |
| 07-validation-window.svg | Ordered preparation and parallel verification |
| 08-runtime-flow.svg | Cross-owner runtime coordination |
