...
def localize(body):
 # Make formerly module-private top-level items visible throughout `apply`.
 out=[]
...
# Chainstate / transition fields are needed by sibling implementation modules.
