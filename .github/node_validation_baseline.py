...
# Final refactor branches must not include these edits.
...
replacement = "        other => encode_payload(other)?.len(),"
assert needle in s
p.write_text(s.replace(needle, replacement, 1))
