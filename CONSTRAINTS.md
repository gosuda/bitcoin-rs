...
| --- | --- | --- | --- | --- | --- | --- | --- |
| ChainAdmission | e82138365787f075f1ebe232e4c609cec47b515d29cd11d29fe7d35c6f522d83 | d9019ce0f244bde70e6fea34c99aff76c3f383bf9268630cab80e3f87506ce67 | EventBudget=12, JobSlots=12, MaxAttempts=4, CounterBound=1024, FrameBound=72, FactBound=36, ReqSlots=12 | 128 | temporal (ConditionalProgress): 16g, 64g, 96g died of heap exhaustion in TemporalPass rewriting; 128g (rc255, 1780s) died on the int32 HashMap table-size overflow (new HashMap table size -2147483648) — Apalache 0.62.2's structural ceiling for this model's temporal rewriting, matching PeerLeases' 96g signature. The heap ladder is complete: no rung passes. NOT a counterexample and NOT a verified pass; the remaining levers (newer Apalache, lower K, fewer CONSTANTS) are all pinned-identity changes awaiting the user decision. chain-safety still in flight | 255 | 14 |
