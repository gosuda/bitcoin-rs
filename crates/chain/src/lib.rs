...
pub use header_sync::{
    accept_headers, at_retarget_boundary, bip94_timewarp_floor, block_work, compact_is_met_by,
    compact_within_pow_limit, current_unix_seconds, permitted_difficulty_transition,
