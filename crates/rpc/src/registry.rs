...
declare_rows! {
    ...
    "prioritisetransaction", SurfaceKind::Rpc, Status::Implemented, "", CORE_VERSION, "See API-19 in docs/contracts/external-api.md for dummy and fee_delta compatibility.", "0.4.0", Some(mining::prioritisetransaction);
