...
declare_rows! {
    ...
    "getprioritisedtransactions", SurfaceKind::Rpc, Status::Implemented, "", CORE_VERSION, "Projects the mempool's signed fee-delta overlay, including txids not currently pooled. See docs/contracts/external-api.md#API-25 for the modified_fee contract.", "0.4.0", Some(mining::getprioritisedtransactions);
