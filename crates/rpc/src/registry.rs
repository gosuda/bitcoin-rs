...
declare_rows! {
    ...
    "getblocktemplate", SurfaceKind::Rpc, Status::Implemented, "", CORE_VERSION, "BIP22/BIP23 template and proposal request parsing (`API-12`).", "0.4.0", Some(mining::getblocktemplate);
