...
declare_rows! {
    ...
    "getblocktemplate", SurfaceKind::Rpc, Status::Implemented, "", CORE_VERSION, "See API-11 and API-14 in docs/contracts/external-api.md for getblocktemplate behavior.", "0.4.0", Some(mining::getblocktemplate);
