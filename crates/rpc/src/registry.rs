...
declare_rows! {
    ...
    "generateblock", SurfaceKind::Rpc, Status::Implemented, "", CORE_VERSION, "See API-27 (docs/contracts/external-api.md) for transaction parsing and error semantics. Invalid-output behavior is defined in docs/contracts/external-api.md#API-29.", "0.4.0", Some(mining::generateblock);
