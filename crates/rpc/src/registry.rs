...
declare_rows! {
    ...
    "submitheader", SurfaceKind::Rpc, Status::Implemented, "", CORE_VERSION, "See API-09 in docs/contracts/external-api.md for submitheader behavior.", "0.4.0", Some(mining::submitheader);
