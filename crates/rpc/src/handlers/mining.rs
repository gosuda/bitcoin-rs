...
/// Enforces the `API-12` mainnet template operational gates.
...
mod tests {
    ...
    // API-12: mainnet template requests require a connected peer.
    #[test]
    ...
    // API-12: mainnet template requests are rejected while the node is in IBD.
    #[test]
    ...
    // API-12: proposal mode bypasses the mainnet connection and IBD gates.
    #[test]
