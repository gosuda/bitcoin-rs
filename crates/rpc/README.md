...
- **System Owners**:
  - **Routing & Demux**: `classify` in `crates/rpc/src/server.rs` owns the listener directory table; see [Transport Demuxing](#1-protocol-demuxing-and-authentication) for the routing rules. Esplora directories: contract WF-02.
