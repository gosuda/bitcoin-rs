...
use bitcoin_rs_mining::{BlockTemplate, Candidate, FakeMiningControl, MiningInfo, TemplateId};
...
/// Canned template for the smoke handler-shape pass; the required-response
/// dispatches read their shapes from these literals.
fn smoke_template() -> BlockTemplate {
...
/// Canned mining info for the smoke handler-shape pass.
fn smoke_info() -> MiningInfo {
    MiningInfo {
        blocks: 0,
        last_candidate: None,
