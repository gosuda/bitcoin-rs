...
///
/// Predecessor formats are reset inside [`IndexWriter::open`] (`IDX-05` /
/// `IDX-04`). This path still full-resets foreign versions and cursorless
/// tables so they can rebuild.
