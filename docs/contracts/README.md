...
| [p2p-wire.md](p2p-wire.md) | `P2P-01`–`P2P-07` | Wire compatibility, peer leases, demonstrated capability, canonical frontier recovery, connected-socket posture, body-carried header admission, header-led announcements and bounded ingress | P2P compatibility/live interop, dispatch/listener, peer-table and sync tests |
