...
| [external-api.md](external-api.md) | `API-01`–`API-12` | RPC/REST/ZMQ manifest, errors, mining RPCs, reference provenance, and BIP22/BIP23 template extras, and mainnet GBT operational gates | manifest coverage, Core parity, mining tests, GBT BIP23 extras and gate tests |
