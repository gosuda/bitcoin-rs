...
| [external-api.md](external-api.md) | `API-01`–`API-07`, `API-11`–`API-13` | RPC/REST/ZMQ manifest, errors, mining RPCs, reference provenance, BIP22/BIP23 template extras, mainnet template gates, `submitheader` | manifest coverage, Core parity, mining tests |
