...
| [external-api.md](external-api.md) | `API-01`–`API-12` | RPC/REST/ZMQ manifest, errors, mining RPCs, reference provenance, and GBT client-rule negotiation | manifest coverage, Core parity, mining tests |
