...
| [external-api.md](external-api.md) | `API-01`–`API-15` | RPC/REST/ZMQ manifest, errors, mining RPCs, reference provenance, BIP22/BIP23 template extras, mainnet GBT operational gates, `submitheader`, GBT client-rule negotiation, and `submitblock` decode | manifest coverage, Core parity, mining tests, GBT BIP23 extras, gate, submitheader, negotiation, and submitblock decode tests |
