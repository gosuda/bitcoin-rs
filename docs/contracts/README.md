...
| [external-api.md](external-api.md) | `API-01`–`API-11` | RPC/REST/ZMQ manifest, errors, mining RPCs, reference provenance, and BIP22/BIP23 template extras | manifest coverage, Core parity, mining tests, GBT BIP23 extras tests |
