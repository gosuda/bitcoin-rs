...
| [support-tests.md](support-tests.md) | `SUP-01`–`SUP-03` | Support scanner syntax and process-harness resource invariants | `bin/bitcoin-rs/tests/support/ownership_scan_tests.rs`; `process_node_tests.rs` |
