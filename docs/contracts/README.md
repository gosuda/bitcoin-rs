...
| [mining-selection.md](mining-selection.md) | `MIN-01` | Snapshot-topology package selection and DAG trust boundary | `crates/mining/src/policy.rs` | `crates/mining/tests/policy_pareto.rs` test `missing_ancestors_fail_assembly_without_rechecking_the_dag` |
