...
| [fast-sync.md](fast-sync.md) | `FS-01`–`FS-03` | Opt-in fast-sync configuration, fan-out threshold, and dynamic window striping | fast-sync configuration and download-window tests |
