...
`accounting.rs` owns resolved-input fee and virtual-size preparation and consumes
the consensus-owned transaction sigop-cost calculation; submission and preview
therefore do not maintain a second BIP141 implementation. Legacy and P2SH sigops
carry the witness scale factor; witness-v0 sigops carry unit cost, following
